...
//             // className="mt-5 rounded-xl bg-gray-900 px-6 py-3 font-semibold text-white"
//           // >
//             {/* Back to Products */}
//           {/* </button> */}
//         {/* </div> */}
...
//         {/* <button */}
//           // onClick={() => navigate("/products")}
//           // className="mb-6 rounded-xl border border-gray-300 bg-white px-5 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-100"
//         // >
//           {/* ← Back to Products */}
//         {/* </button> */}
// {/*  */}
...
//               // className="mt-6 w-full rounded-xl bg-gray-900 px-6 py-3 font-semibold text-white transition hover:bg-blue-600 disabled:cursor-not-allowed disabled:bg-gray-400"
//             // >
//               {/* {product.stock > 0 */}
//                 // ? "Add to Cart"
//                 // : "Out of Stock"}
